                    ...
                    {OPTIMIZATION_PROFILES.map(profile => {
                      ...
                      return (
                        <button key={profile.id}
                          ...
                          className={`text-left p-3.5 rounded-xl border transition-all cursor-pointer relative ${isSelected ? "bg-[#0D1225] border-emerald-700/50 shadow-lg" : "bg-[#080C16] border-[#1A2138] hover:border-slate-700"}`}>
              ...
              <div className="space-y-4">
                <div className="bg-[#0D1225] border border-[#1A2138] rounded-2xl p-5 space-y-3">
                  ...
                  {[
                    ...
                    <div key={tip.t} className="p-2.5 rounded-lg bg-[#080C16] border border-[#1A2138]">
